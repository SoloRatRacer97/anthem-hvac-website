            ...
            <tr>
              <td style="padding:26px 32px;background:#07101f;color:#ffffff;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tr>
                    <td>
                      <img src="cid:anthem-logo" width="265" alt="Anthem Cooling, Heating &amp; Plumbing" style="display:block;width:265px;max-width:100%;height:auto;border:0;outline:none;text-decoration:none;">
                    </td>
