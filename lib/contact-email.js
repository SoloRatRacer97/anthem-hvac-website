      ...
      <tr>
        <td align="center" style="padding:32px 12px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="width:100%;max-width:640px;background-color:#ffffff;border-collapse:separate;border-spacing:0;border-radius:14px;overflow:hidden;box-shadow:0 12px 32px rgba(7,16,31,.12);">
            <tr><td bgcolor="#f0162d" style="height:7px;background-color:#f0162d;font-size:0;line-height:0;">&nbsp;</td></tr>
            <tr>
              <td align="center" bgcolor="#07101f" style="padding:28px 24px 24px;background-color:#07101f;color:#ffffff;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tr>
                    <td align="center" bgcolor="#07101f" style="background-color:#07101f;">
            ...
            <tr>
              <td align="center" bgcolor="#07101f" style="padding:0 24px 25px;background-color:#07101f;color:#ffffff;">
                <span style="display:inline-block;padding:7px 12px;border:1px solid #f0162d;border-radius:999px;background-color:#f0162d;color:#ffffff;font-size:11px;line-height:14px;font-weight:800;letter-spacing:.8px;text-transform:uppercase;">${pageType} Lead</span>
              </td>
            </tr>
            <tr>
