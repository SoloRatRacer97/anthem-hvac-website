...
<html lang="en">
  ...
  <body style="margin:0;padding:0;background:#f4f6f8;color:#07101f;font-family:Arial,Helvetica,sans-serif;">
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f4f6f8;">
      <tr>
        <td align="center" style="padding:32px 12px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:640px;background:#ffffff;border-collapse:separate;border-spacing:0;border-radius:14px;overflow:hidden;box-shadow:0 12px 32px rgba(7,16,31,.12);">
            <tr><td style="height:7px;background:#f0162d;font-size:0;line-height:0;">&nbsp;</td></tr>
            <tr>
              <td style="padding:26px 32px;background:#07101f;color:#ffffff;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tr>
                    <td>
                      <div style="font-size:30px;line-height:34px;font-weight:900;letter-spacing:-1px;">ANTHEM<span style="color:#f0162d;">.</span></div>
                      <div style="margin-top:4px;color:#cbd5e1;font-size:12px;line-height:18px;font-weight:700;letter-spacing:1.4px;text-transform:uppercase;">Air Conditioning &amp; Plumbing</div>
                    </td>
                    <td align="right" valign="top">
                      <span style="display:inline-block;padding:7px 10px;border-radius:999px;background:#f0162d;color:#ffffff;font-size:11px;line-height:14px;font-weight:800;letter-spacing:.8px;text-transform:uppercase;">New Website Lead</span>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:30px 32px 12px;">
                <div style="margin-bottom:10px;color:#0545a7;font-size:12px;line-height:16px;font-weight:800;letter-spacing:1px;text-transform:uppercase;">${pageType} Submission</div>
            ...
            <tr>
              <td style="padding:18px 32px 8px;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f6f7f9;border-left:5px solid #f0162d;border-radius:8px;">
                  <tr>
            ...
            <tr>
              <td style="padding:18px 32px;background:#07101f;color:#cbd5e1;font-size:11px;line-height:18px;text-align:center;">
