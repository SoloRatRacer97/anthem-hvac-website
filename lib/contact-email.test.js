...
describe('SendGrid contact email', () => {
  ...
  it('sends text and escaped HTML content to SendGrid', async () => {
    ...
    expect(body.content[1].value).toContain('ANTHEM<span style="color:#f0162d;">.</span>');
    expect(body.content[1].value).toContain('background:#07101f');
    ...
    expect(body.content[1].value).toContain('Contact Page Submission');
